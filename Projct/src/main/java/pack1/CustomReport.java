...
public class CustomReport implements IReporter {
	...
	private static final String emailableReportTemplateFile = "E:\\Projct\\src\\pack1\\Report.html";
	@Override
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		...
		try
		{
			...
			String customReportTitle = this.getCustomReportTitle("Release - Custom TestNG Report");
	...
	private String readEmailabelReportTemplate()
	{
		...
		try {
			...
			File file = new File(CustomReport.emailableReportTemplateFile);
	...
	private String getTestMethodReport(String testName, IResultMap testResultMap, boolean passedReault, boolean skippedResult)
	{
		...
		for(ITestResult testResult : testResultSet)
		{
			...
			retStrBuf.append("<td>");
			retStrBuf.append("<a>");
			String path = System.getProperty("scr.folder");
			
			retStrBuf.append(path);
			retStrBuf.append("</a>");
			retStrBuf.append("</td>");
